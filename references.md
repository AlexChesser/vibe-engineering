...
*   Cursor Rules: [https://docs.cursor.com/en/context/rules#rules](https://docs.cursor.com/en/context/rules#rules)
*   DORA (DevOps Research and Assessment): [https://dora.dev/](https://dora.dev/)
